#Программа выполняет поиск типичных структур на исходном изображении создавая копию изображения с обнаруженными совпадениями и файл с координатами структур#
